...
type AddReq struct {
	...
	Type kernel.RuleType `protobuf:"varint,5,opt,name=type,proto3,enum=tech.storezhang.dnsabre.core.kernel.RuleType" json:"type,omitempty" default:"1" validate:"omitempty,oneof=1 2"`
	// 更新间隔
	// 默认为5个小时
	// @gotags: default:"18000s"
	Interval *durationpb.Duration `protobuf:"bytes,6,opt,name=interval,proto3" json:"interval,omitempty" default:"18000s"`
	// 信息
